...
function addNew() {
  ...
  if (checkErrorElement) {
    ...
    //   : [];
    let listStudent = new Array(name, address);
    listStudent = localStorage.getItem("list-student")
      ? JSON.parse(localStorage.getItem("list-student"))
      : [];
    listStudent.push({
      name: name,
    ...
    student += `<tr>
          ...
          <td>
            ...
            <button onclick="deleteStudent(${index})">delete</button>
             <button onclick="dongydathang()">Trang Chu</button>
          </td>
...
//   var ttnh = document.querySelector(".form");
//   var hoten = ttnh[0].children[1].children[2].value;
//   var diachi = ttnh[0].children[1].children[1].value;
//   var nguoinhan = new Array(hoten, diachi);
...
function redirectStudent() {
  ...
  // console.log(nguoinhan);
  let vy = Object.keys(thongtin).reduce((acc, key) => {;
  console.log(vy);
  tt += ` <img src="${thongtin.address}"with="100px" alt=" anh dep>`;
