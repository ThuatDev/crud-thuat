    ...
    student += `<tr>
          ...
          <td>
            ...
            <button onclick="deleteStudent(${index})">delete</button>
             <a href="sanpham.html">Trang Chu</a>
          </td>
...
function renderStudent() {
  ...
  var nguoinhan = JSON.parse(nguoinhan);
  var hoten = nguoinhan[0];
  var diachi = nguoinhan[1];
  var ttnh = document.querySelector(".form");
  ttnh[0].children[1].children[0].innerHTML = hoten;
  ttnh[0].children[1].children[1].innerHTML = diachi;
  dichitiet();
}
